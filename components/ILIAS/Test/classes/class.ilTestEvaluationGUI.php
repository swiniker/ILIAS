...
class ilTestEvaluationGUI extends ilTestServiceGUI
{
    ...
    */
    ...
    {
        $ilUserCertificateRepository = new ilUserCertificateRepository($this->db);
        $pdfGenerator = new ilPdfGenerator($ilUserCertificateRepository, $this->logger->getComponentLogger());
    ...
    protected function getFilteredTestResult(
        ...
        $question_list = new ilAssQuestionList($ilDB, $this->lng, $component_repository);
